...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        Dual Side mount A & S17 & 4 & \partimg{../../../images/parts_list/S17.jpg} & \#6-32x3/8" Button Head Screw & B2 & 4 & \partimg{../../../images/parts_list/B2.png} \\ \hline
        4.5"x12" Aluminum Plate & S37 & 2 & \partimg{../../../images/parts_list/S37.jpg} &  &  &  &  \\ \hline
        ...
        \#6-32x1/4" Button Head Screw & B1 & 16 & \partimg{../../../images/parts_list/B1.png} & & & & \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \#6-32x1/4" Spacer & T1 & 8 & \partimg{../../../images/parts_list/T1.png} & Allen Key Set & D2 & & \partimg{../../../images/parts_list/D2.jpeg} \\ \hline
         \#6-32x1/4" Button Head Screw & B1 & 8 & \partimg{../../../images/parts_list/B1.png} & 0.5" Clamping Hub & S13 & 1 & \partimg{../../../images/parts_list/S13.png}\\ \hline
        0.5" Bottom Bore clamping hub & S20 & 2 & \partimg{../../../images/parts_list/S20.jpg} & Single pattern bracket & S8 & 1 & \partimg{../../../images/parts_list/S8.jpg}\\ \hline
        0.5" Hallow aluminum tube 2" long & S18 & 1 & \partimg{../../../images/parts_list/S18.png} & 0.5" Collar clamp & S22 & 1 & \partimg{../../../images/parts_list/S22.png}\\ \hline
        0.5" Nylon Washer & W3 & 5 & \partimg{../../../images/parts_list/W3.png} &  \#6-32 Hexnuts & B11 & 4 & \partimg{../../../images/parts_list/B11.png} \\ \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
  \centering
  \begin{minipage}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{"Pictures/Body/body_dif_1".PNG}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{"Pictures/Body/body_dif_2".PNG}
  \end{minipage}
...
\begin{figure}[H]
  \centering
  \begin{minipage}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{"Pictures/Body/Step 6".PNG}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{"Pictures/Body/Step 7".PNG}
  \end{minipage}
...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        Assembled Control Board PCB  & E1 & 1 & \partimg{../../../images/parts_list/E1.PNG} & \#6-32x3/8" Button Head Screw & B2 & 4 & \partimg{../../../images/parts_list/B1.png} \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        Dual Side Mount A & S17 & 12 & \partimg{../../../images/parts_list/S17.jpg} & \#6-32x1/4" Button Head Screw & B1 & 28 & \partimg{../../../images/parts_list/B1.png} \\ \hline
        9"x12" Aluninum Plate & S35 & 1 & \partimg{../../../images/parts_list/S35.jpg} & Volt Meter & E38 & 1 & \partimg{../../../images/components/E38.png} \\ \hline
	Laser Cut Front Panel & S39 & 1 & \partimg{../../../images/parts_list/S39.PNG} & Laser Cut Back Panel & S40 & 1 & \partimg{../../../images/parts_list/S40.PNG}\\ \hline
	Switch & E39 & 1 & \partimg{../../../images/components/E39.png} & 3D printed Battery Holder & S41 & 2 & \partimg{../../../images/components/S41.png} \\ \hline
	\# 6-32 Heat set insert & I1 & 4 & \partimg{../../../images/components/I1.png} & & & & \\ \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{"Pictures/Body/body_11".PNG}
	\caption{Mounting the PCB}
\end{figure}
