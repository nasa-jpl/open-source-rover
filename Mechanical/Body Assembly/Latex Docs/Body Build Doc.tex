...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        Dual Side Mount A & S17 & 12 & \partimg{../../../images/parts_list/S17.jpg} & \#6-32x1/4" Button Head Screw & B1 & 24 & \partimg{../../../images/parts_list/B1.png} \\ \hline
...
\begin{figure}[H]
  \centering
  \begin{minipage}[b]{0.40\textwidth}
    \includegraphics[width=\textwidth]{"Pictures/Body/body_bottom_1".PNG}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.40\textwidth}
    \includegraphics[width=\textwidth]{"Pictures/Body/body_bottom_2".PNG}
  \end{minipage}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.45\textwidth]{"Pictures/Body/body_11".PNG}
	\caption{Mounting the PCB}
\end{figure}
