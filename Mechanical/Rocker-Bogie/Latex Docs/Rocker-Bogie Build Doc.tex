...
\item \textbf{Attachment for Front Corner:} Attach 3.75 inch channel \textbf{S3} to the top hole of the pattern F bracket using spacers \textbf{T1}, screws \textbf{B4}, and hexs nuts \textbf{B11} as shown in Figure \ref{attaching channel corner}. 
