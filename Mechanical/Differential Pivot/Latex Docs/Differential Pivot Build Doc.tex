...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \hline
        0.5" x 3' Aluminum Tube & S16 & 1 & \partimg{../../../images/components/Structural/S16.png} & Metal Hacksaw or Bandsaw & D4 & & \partimg{../../../images/components/Tools/D4.png} \\ \hline
        0.5" x 4" Aluminum Tube & S18 & 4 & \partimg{../../../images/components/Structural/S18.png} & Vice clamp or C Clamps & D5 & & \partimg{../../../images/components/Tools/D5.png} \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        0.5" x 13.5" Aluminum Tube (Modified) & S16B & 1 & \partimg{../../../images/components/Structural/S16.png} & Hand Drill or Drill Press & D3 & & \partimg{../../../images/components/Tools/D3.png} \\ \hline
        0.5" x 3" Aluminum Tube (Modified) & S18A & 2 & \partimg{../../../images/components/Structural/S18.png} & Center punch or Starter drill bit & D7 & & \partimg{../../../images/components/Tools/D7.jpeg} \\ \hline
        Vice or V-Clamp & D8 & & \partimg{../../../images/components/Tools/D8.png} & Drill bit \#23 & D6 & & \partimg{../../../images/components/Tools/D6.jpeg} \\ \hline
    \end{tabular}
\end{table}

The turnbuckles must be attached to the differential pivot and rocker-bogie arm. We will accomplish this by drilling holes in the aluminum beam \textbf{S16B} and attaching two 5-hole aluminum bars on each side.
...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        Single Pattern Bracket & S8 & 1 & \partimg{../../../images/components/Structural/S8.jpg} & \#6-32x1.25" Button Head Screw & B7 & 8 & \partimg{../../../images/components/Screws/B7.png} \\ \hline
        0.5" Circular Clamping Hub & S13 & 1 & \partimg{../../../images/components/Structural/S13.png} & \#4-40x1.25" Button Head Screw & B9 & 4 & \partimg{../../../images/components/Screws/B9.png} \\ \hline
        0.5" Bottom Bore Clamp & S20 & 2 & \partimg{../../../images/components/Structural/S20.jpg} & \#6-32 Locking Hex Nut & B11 & 8 & \partimg{../../../images/components/Screws/B11.png} \\ \hline
        0.5" x 13.5" Aluminum Tube (Modified) & S16B & 1 & \partimg{../../../images/components/Structural/S16B.png} & \#4-40 Locking Hex Nut & B12 & 4 & \partimg{../../../images/components/Screws/B12.png} \\ \hline
        0.5" x 3" Aluminum Tube (Modified) & S18B & 2 & \partimg{../../../images/components/Structural/S18B.png} & \#4-40 Washer & W2 & 24 & \partimg{../../../images/components/Washers/W2.png} \\ \hline
        5 Hole Aluminum Beam & S21 & 8 & \partimg{../../../images/components/Structural/S21.jpg} & Allen Key Set & D2 & & \partimg{../../../images/components/Tools/D2.jpeg} \\ \hline
        RC Turnbuckles & S32 & 2 & \partimg{../../../images/components/Structural/S32.jpg} & Wrench Set & D1 & & \partimg{../../../images/components/Tools/D1.jpg} \\ \hline
        \#6-32x1/4" Button Head Screw & B1 & 8 & \partimg{../../../images/components/Screws/B1.png} & & & & \\ \hline
    \end{tabular}
\end{table}

\begin{enumerate}
  \item \textbf{Build clamping hub assembly:} Attach the the bottom bore clamping hubs \textbf{S20} to the single pattern bracket \textbf{S8} using screws \textbf{B1}. Then mount the 0.5" clamping hub \textbf{S13} to the bottom of this assembly using \textbf{B1} screws. 
