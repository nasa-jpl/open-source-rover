...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        4mm Face Tapped Clamp Hub & S14 & 6 & \partimg{../../../images/components/Structural/S14.jpg} & Metal Hacksaw or Bandsaw & D4 & & \partimg{../../../images/components/Tools/D4.png} \\ \hline
        Vice or C Clamps & D5 & & \partimg{../../../images/components/Tools/D5.png} & & & & \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        3" Channel & S2 & 6 & \partimg{../../../images/components/Structural/S2.jpg} & Motor w/Encoder (Drive Motor) & E45 & 6 & \partimg{../../../images/components/Electronics/E45.png} \\ \hline
        4mm Face Tapped Clamp Hub (Modified) & S14A & 6 & \partimg{../../../images/components/Structural/S14A.png} & \#6-32x1/4" Button Head Screw & B1 & 24 & \partimg{../../../images/components/Screws/B1.png} \\ \hline
        25mm Bore Side Tapped Clamping Mount & S25 & 6 & \partimg{../../../images/components/Structural/S25.jpg} & \#6-32x3/4" Button Head Screw & B5 & 12 & \partimg{../../../images/components/Screws/B5.png} \\ \hline
        Wheels & S30A & 6 & \partimg{../../../images/components/Structural/S30.jpg} & Allen Key Set & D2 & & \partimg{../../../images/components/Tools/D2.jpeg} \\ \hline
        Loctite 2-part epoxy & S36 & & \partimg{../../../images/components/Structural/S36.jpg} & 5/16" Wrench & D1 & & \partimg{../../../images/components/Tools/D1.jpg} \\ \hline
    \end{tabular}
\end{table}
...
\item \textbf{Clamping Hub attachment/Apply Loctite Epoxy:} Next, take the modified 4mm clamping hub \textbf{S14A} and clamp it around the motor shaft as shown. Take careful note to have the flat side pointing towards the wheel, and the raised edge towards the motor. We recommend applying Loctite 2-part Epoxy \textbf{S36} between the motor shaft and the clamping hub at their interface\footnote{Epoxy will help hold the high torque of the system and keep this interface from slipping, but it also means that your motor will have the clamping hub permanently attached onto it.}.
...
\begin{table}[H]
    ...
    \begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
        ...
        \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} & \thead{Item} & \thead{Ref} & \thead{Qty} & \thead{Image} \\
        \hline
        3" Channel & S2 & 4 & \partimg{../../../images/components/Structural/S2.jpg} & \#6-32x1/4" Screw & B1 & 76 & \partimg{../../../images/components/Screws/B1.png} \\ \hline
        4.5" Channel & S4 & 4 & \partimg{../../../images/components/Structural/S4.jpg} & \#6-32x1/2" Button Head Screw & B3 & 8 & \partimg{../../../images/components/Screws/B3.png} \\ \hline
        Channel Connector Plate & S6 & 16 & \partimg{../../../images/components/Structural/S6.jpg} & \#6-32x3/4" Threaded Standoff & T3 & 4 & \partimg{../../../images/components/Standoffs/T3.PNG} \\ \hline
        0.25" Face Tapped Clamping Hub & S12 & 4 & \partimg{../../../images/components/Structural/S12.jpg} & Allen Key Set & & & \partimg{../../../images/components/Tools/D2.jpeg} \\ \hline
        48 Tooth Plain Bore Gear & S26 & 4 & \partimg{../../../images/components/Structural/S26.jpg} & 5/16" Wrench & & & \partimg{../../../images/components/Tools/D1.jpg} \\ \hline
        Loctite Threadlocker & S34 & & \partimg{../../../images/components/Structural/S34.jpg} & & & & \\ \hline
    \end{tabular}
\end{table}
