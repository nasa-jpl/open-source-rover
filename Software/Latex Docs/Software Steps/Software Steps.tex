...
\end{itemize}
Make sure that this shows serial0 -$>$ ttyS0 . If it does not then follow the above steps again making sure to select the correct settings at each step. Next, edit the /boot/cmdline.txt file:
\begin{itemize}
