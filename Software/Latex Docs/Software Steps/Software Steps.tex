...
\begin{itemize}
	...
	\item[] Create a catkin workspace directory: (read more \href{http://wiki.ros.org/catkin/Tutorials/create_a_workspace}{here}): \colorbox{lightgray}{mkdir /home/pi/catkin\_ws}
	\item[] Copy the source files to your catkin workspace: \colorbox{lightgray}{mv led\_screen/ osr/ osr\_bringup/ osr\_msgs/ src}
