...
\begin{enumerate}
	\item The board will come unpopulated, first, solder all of the header pins, resistors, and op amp chips into the board. Make sure that the OP-amp is facing the correct direction, there is a half moon on the top of the chip as well as on the silk screen on the board. 
