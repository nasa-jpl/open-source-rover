...
\begin{table}[H]
	...
	\begin{tabular}{|N|Q|Q|I|N|Q|Q|I|}
			...
			Rectangular 40P 2x20 Ribbon Cable & E29 & 1 & \partimg{../../../images/components/Electronics/E29.png} & Rectangular 16P Ribbon Cable & E30 & 1 & \partimg{../../../images/components/Electronics/E39.png} \\ \hline
			USB to TTL Serial Adapter & E 48 & 1 & \partimg{../../../images/components/Electronics/E48.png} & & & & \\ \hline
	\end{tabular}
\end{table}

We will next plug in all the cables that allow devices to communicate to each other. 
...
\textcolor{red}{EACH OF THESE NEEDS PICTURES ASSOCIATED}
