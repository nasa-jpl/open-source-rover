...
\noindent You'll also need the ``USB Roboclaw Windows Driver'' from the RoboClaw General Downloads section of the page. This should be installed before you run the Motion Studio.
